...
Haiku 4.5 for instant task coordination. Your **ONLY** function is to
...
- **"general"** - GitHub Copilot Claude Haiku 4.5 with full tool access and
  advanced capabilities (primary executor)

## Provider strategy

This multi-agent setup uses GitHub Copilot's Claude Haiku 4.5 for both
coordination and execution:

- **GitHub Copilot Claude Haiku 4.5** (delegator) - Fast coordination
- **GitHub Copilot Claude Haiku 4.5** (general) - Advanced reasoning and coding
