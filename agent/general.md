...
Full tool access with GitHub Copilot Claude Haiku 4.5 capabilities - executes
...
delegator agent cannot perform directly. Uses GitHub Copilot's Claude Haiku 4.5
...
- **GitHub Copilot Claude Haiku 4.5** (delegator) - Fast coordination
- **GitHub Copilot Claude Haiku 4.5** (general) - Most capable reasoning and
  coding
...
leveraging GitHub Copilot's Claude Haiku 4.5 capabilities for superior
